...
public class Main {
    public static void main(String[] args) {
        ...
        Comprador comprador = new Comprador("Borja","Gonzales","Barcelona");
        System.out.println("La dirección del envío del coche es "+comprador.getDireccion());
        // obtener el precio del coche
        mondeo.setPrecio(30000);
